...
db_password = '1Million$'  # Set to your own password
engine = create_engine('postgresql://postgres:{}@localhost/Algo_Trading_DB'.format(db_password))
...
prices_df2 = pd.read_sql_query('select * from daily_prices', engine, index_col=['ticker', 'date'])
